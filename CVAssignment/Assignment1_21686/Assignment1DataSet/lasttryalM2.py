...
destinationXs=np.matrix([[0],[1000],[0]])
destinationYs=np.matrix([[0],[690],[690]])# 2nd point was 1000,2
...
##################################################################################
matrixtmp=np.matrix([[10,5,1],[150,970,1],[694,900,1]])#2nd point was [980,127,1]
OriginalPointMAtrix=np.linalg.inv(matrixtmp)
